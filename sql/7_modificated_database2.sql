...
-- -----------------------------------------------------
-- Table `new_db`.`company`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`company`
(
    ...
    PRIMARY KEY (`com_id`),
    UNIQUE INDEX `id_UNIQUE` (`com_id` ASC) VISIBLE
)
    ENGINE = InnoDB
    AUTO_INCREMENT = 1;
...
(
    ...
    CONSTRAINT `address_FK`
        FOREIGN KEY (`com_id`)
            REFERENCES `new_db`.`company` (`com_id`)
            ON DELETE CASCADE
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB
...
-- Table `new_db`.`cattle`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`cattle`
(
    `com_id`                    INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `new_db`.`coefficients`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`coefficients`
(
    `com_id`                            INT    NOT NULL,
...
-- -----------------------------------------------------
-- Table `new_db`.`company_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`company_info`
(
    `com_id`           INT         NOT NULL,
...
-- -----------------------------------------------------
-- Table `new_db`.`crop_production`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`crop_production`
(
    `id`              INT    NOT NULL AUTO_INCREMENT,
    `com_id`          INT    NOT NULL,
...
-- -----------------------------------------------------
-- Table `new_db`.`dairy_products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`dairy_products`
(
    `com_id`                     INT    NOT NULL,
...
-- -----------------------------------------------------
-- Table `new_db`.`enterprise_statistic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`enterprise_statistic`
(
    `id`                        INT NOT NULL AUTO_INCREMENT,
    `com_id`                    INT NOT NULL,
    `column_index`              INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `new_db`.`expenses`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`expenses`
(
    `com_id`                INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `new_db`.`fixed_assets`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`fixed_assets`
(
    `com_id`               INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `new_db`.`grounds`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`grounds`
(
    `id`               INT    NOT NULL AUTO_INCREMENT,
    `com_id`           INT    NOT NULL,
...
-- Table `new_db`.`header`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`header`
(
    `id`   INT  NOT NULL AUTO_INCREMENT,
    `text` TEXT NOT NULL,
    PRIMARY KEY (`id`)
...
-- -----------------------------------------------------
-- Table `new_db`.`sales_return`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_db`.`sales_return`
(
    `com_id`                        INT    NOT NULL,
...
CREATE TABLE IF NOT EXISTS `new_db`.`correlation`
(
    `com_id`                               INT    NOT NULL,
